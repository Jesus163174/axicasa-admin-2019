...
@section('slider')
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{'http://localhost:80/'.$livingPlace->portada}});"  data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <span class="d-inline-block {{$livingPlace->tipo_venta == 'compra' ? 'bg-success' : 'bg-danger'}} text-white px-3 mb-3 property-offer-type rounded">{{$livingPlace->tipo_venta}}</span>
                    <h1 class="mb-2">{{$livingPlace->titulo}}</h1>
                    <p class="mb-5"><strong class="h2 text-success font-weight-bold">${{number_format($livingPlace->costo,2,'.',',')}}</strong></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div>
                        <div class="slide-one-item home-slider owl-carousel">
                            @foreach($fotos as $foto)
                                <div><img src="{{'http://localhost:80/'.$foto->url_foto}}" alt="Image" class="img-fluid"></div>
                            @endforeach
                        </div>
                    </div>
